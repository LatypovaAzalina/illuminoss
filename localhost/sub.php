...
<div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">399$ </div>
                            <div class="nazvanie">за месяц</div>
                            <div class="h__f">Оплата ежемесячно
                            </div> <a href="https://www.tinkoff.ru/cf/5HnxBiZzQVi" class="cta_btn">Оформить подписку</a>
                ...
                <div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">299$ </div>
                            <div class="nazvanie">за месяц</div>
                            <div class="h__f">899$ за 3 месяца
                            </div> <a href="https://www.tinkoff.ru/cf/5HnxBiZzQVi" class="cta_btn">Оформить подписку</a>
                ...
                <div class="cart">
                    <div class="photo__cart">
                        ...
                        <div class="text">
                            <div class="nazvanie">199$</div>
                            <div class="nazvanie">за месяц</div>
                            <div class="h__f"> 2390$ за 12 месяца
                            </div> <a href="https://www.tinkoff.ru/cf/5HnxBiZzQVi" class="cta_btn">Оформить подписку</a>
